...
const LoginModal: React.FC<LoginModalProps> = ({ onClose, onLogin }) => {
  ...
  const renderRolePicker = () => (
    <div className="role-selector" role="tablist" aria-label="Role Selection">
      <button 
        type="button"
        role="tab"
      ...
      case 'phone':
        return (
          <form onSubmit={handleGetOTP} className="login-form">
            ...
            <p className="modal-subtitle">Choose your role and enter your mobile number</p>
            {renderRolePicker()}
            ...
            <div className="login-options">
              <button type="button" className="auth-button google" onClick={handleGoogleLogin}>
              ...
              <button type="button" className="auth-button email" onClick={() => setStep('email-auth')}>
